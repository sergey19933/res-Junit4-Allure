...
public class DepositsPage extends BasePage {
    ...
    public DepositsPage checkPage(String nameCheckPage) {
        ...
        Assert.assertEquals("Заголовок не соответствует требуемому", nameCheckPage, checkPage.getText());
        return this;
    }
    ...
    public DepositsPage choiceCurrency(String currency) {
        ...
        Assert.fail("Валюта '" + currency + "' не найдена");
        return this;
    }
...
//                        .replaceAll("[^0-9]", ""), value, "Не совпадает");
                ...
                Assert.assertEquals("Не совпадает", value, checkFillWithdrawing.getText()
                        .replaceAll("[^0-9,]", ""));
                break;
...
//                        .replaceAll("[^0-9]", ""), value, "Не совпадает");
                ...
                Assert.assertEquals("Не совпадает", value, checkFillTopUp.getText()
                        .replaceAll("[^0-9,]", ""));
...
//                        .replaceAll("[^0-9]", ""), value, "Не совпадает");
                ...
                Assert.assertEquals("Не совпадает", value, checkFillAccrued.getText()
                        .replaceAll("[^0-9,]", ""));
